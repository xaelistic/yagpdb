...
import (
	...
	eventModels "github.com/xaelistic/yagpdb/v2/common/scheduledevents2/models"
	...
	"github.com/xaelistic/yagpdb/v2/rsvp/models"
...
func (p *Plugin) AddCommands() {
	...
	cmdCreateEvent := &commands.YAGCommand{
		...
		RequireDiscordPerms: []int64{discordgo.PermissionManageGuild, discordgo.PermissionManageEvents},
		Plugin:      p,
