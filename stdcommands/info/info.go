...
The bot is run by Botlabs but is open source (<https://github.com/xaelistic/yagpdb>), so if you know Go and want to make some contributions, feel free to make a PR.
